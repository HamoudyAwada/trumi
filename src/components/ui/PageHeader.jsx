...
/* ─────────────────────────────────────────────
   PageHeader
   Consistent app header present on every page
   except Chat. Logo navigates to home.
───────────────────────────────────────────── */

function TrumiLogoMark() {
  return (
    <svg className="page-header__logo" viewBox="0 0 1080 1080" fill="none" aria-hidden="true">
...
export default function PageHeader({ title }) {
  ...
  return (
    <div className="page-header">
      ...
      >
        <TrumiLogoMark />
        <span className="page-header__wordmark">trumi</span>
      </button>
